...
const SERVICES = [
  {
    ...
    desc: "We create intuitive and scalable mobile applications designed to enhance user engagement, streamline operations, and support long-term digital growth across iOS and Android platforms.",
    features: [
    ...
    stats: [
      { value: "User-Centric Design", label: "Seamless Digital Experiences" },
      { value: "Scalable Solutions", label: "Built for Business Growth" },
      { value: "Reliable Performance", label: "Optimized Across Devices" },
    ],
...

  {
    ...
    desc: "We develop tailored software solutions that align with your operational workflows, business objectives, and future scalability requirements.",
    features: [
    ...
    stats: [
      { value: "Business-Focused", label: "Solutions Tailored to Operations" },
      { value: "Future-Ready Systems", label: "Designed for Scalability" },
      { value: "Efficient Architecture", label: "Built for Long-Term Reliability" },
    ],
...

  {
    ...
    desc: "Modern cloud infrastructure and DevOps practices that improve operational efficiency, deployment agility, and system scalability.",
    features: [
    ...
    stats: [
      { value: "Scalable Infrastructure", label: "Designed for Business Expansion" },
      { value: "Operational Efficiency", label: "Streamlined Deployment Processes" },
      { value: "Reliable Cloud Systems", label: "Optimized Performance & Stability" },
    ],
...

  {
    ...
    desc: "Comprehensive cybersecurity solutions focused on safeguarding digital assets, ensuring compliance, and strengthening operational resilience.",
    features: [
    ...
    stats: [
      { value: "Security-First Approach", label: "Protection Across Systems" },
      { value: "Compliance-Oriented", label: "Aligned with Industry Standards" },
      { value: "Continuous Monitoring", label: "Proactive Risk Management" },
    ],
